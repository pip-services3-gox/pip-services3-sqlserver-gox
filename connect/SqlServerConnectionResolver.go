...
func (c *SqlServerConnectionResolver) validateConnection(correlationId string, connection *cconn.ConnectionParams) error {
	uri := connection.Uri()
	if uri != "" {
		return nil
	}
...
func (c *SqlServerConnectionResolver) validateConnections(correlationId string, connections []*cconn.ConnectionParams) error {
...
func (c *SqlServerConnectionResolver) Resolve(ctx context.Context, correlationId string) (uri string, err error) {
